      ...
      <footer class="entry-footer">
        ...
        <section class="flex-icon-five">
            ...
            <div class="form-group" id="flag-btn">
              <div class="input-group mb-2 mt-1">
                <div class="input-group-prepend">
                  ...
                  <button class="btn btn-primary btn-sm flag-form-btn" data-key="flag-<?php echo get_the_ID(); ?>"
                    data-list-id="<?php echo $post_id; ?>" data-flag-email="<?php echo get_field('your_email'); ?>">
                    Flag
                  </button>
                </div>
              </div>
          ...
          <div class="flex-icon-item ml-3">
            <input type="checkbox" name="list-hmu-checkbox" id="list-hmu-checkbox" class="list-hmu-checkbox ml-5"
              autocomplete="off" data-hmu="<?php echo get_field('your_email'); ?>" style="background: black;">
