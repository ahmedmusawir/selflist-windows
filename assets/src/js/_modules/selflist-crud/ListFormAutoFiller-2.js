...
class ListFormAutoFiller {
  ...
  fillListInsertForm = () => {
    ...
    if (fakeListPageUserData) {
      this.contactName.val(fakeListPageUserData.userName);
      this.contactPhone.val(fakeListPageUserData.userPhone);
      this.contactEmail.val(fakeListPageUserData.userEmail);
    } else {
