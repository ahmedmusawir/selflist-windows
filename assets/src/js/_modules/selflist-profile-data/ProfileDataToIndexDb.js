...
class ProfileDataToIndexDb extends ProfileDataToDbAjax {
  constructor() {
    // This code loads up the Member Profile data and inserts into indexedDB (variable: info) so that
    // data can be auto loaded on to the List Insert page form via this code:
    // [selflist-crud/ListFormAutoFiller.js]
